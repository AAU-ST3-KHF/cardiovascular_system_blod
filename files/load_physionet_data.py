...
pn_dir = Path("files/physionet.org/files/autonomic-aging-cardiovascular/1.0.0")
# f2* (young + old) have BP according to the database docs
records =[f.stem for f in pn_dir.glob("*.hea") if int(f.stem)<101]
...
SAMPLINGS_RATE_GOAL = 100
N_SAMPLES = 10000


# This creates a folder for saving data to
out_dir = Path("files/autonomic-aging-cardiovascular")
